...
regress2:
	comparator $(OPTS) -d $(UNIX) $(SRC1) | dumpscf >test1-old.dump
	comparator $(OPTS) -d $(UNIX) $(SRC2) | dumpscf >test2-old.dump
	comparator $(OPTS) -c -d $(UNIX) $(SRC1) $(SRC2)
...
regress3:
	comparator $(OPTS) -d $(UNIX) $(SRC1) $(SRC2) >test1.dump
	comparator $(OPTS) -c -d $(UNIX) $(SRC1) $(SRC2)
...
sco.ovl:
	time comparator -v $(OPTS) -d $(UNIX) src5r4 linux-2.4.19 >sco.ovl
